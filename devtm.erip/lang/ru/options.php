...
$MESS["DEVTM_ERIP_FOR_PAYER_DESC"] = "Назначение платежа (используйте %s для подстановки номера заказа в сообщении)";
...
$MESS["DEVTM_ERIP_RECEIPT_PAYER_DESC"] = "Информация для чека (используйте %s для подстановки номера заказа в сообщении)";
